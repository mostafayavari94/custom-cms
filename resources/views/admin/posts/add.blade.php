          ...
          @endif           
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="addform" action="/admin/posts/add" enctype="multipart/form-data" method="post"><input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="row"> 
                            <div class="col-md-6"> 
                        ...
                        <div class="row"> 
                            <div class="col-md-12"> 
                                <div class="form-group no-margin"> 
                                    ...
                                    <textarea class="form-control autogrow" id="abstract" name="abstract" placeholder="چکیده" style=""></textarea>
                                </div> 
                            </div> 
                        </div>
                        <div class="row"> 
                            <div class="col-md-12"> 
                                <div class="form-group no-margin"> 
                                    ...
                                    <textarea class="form-control autogrow" id="text" name="text" placeholder="متن اصلی" style=""></textarea>
                                </div> 
                            </div> 
                        </div> 
